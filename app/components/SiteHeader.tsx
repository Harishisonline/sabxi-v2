    ...
    <header className={`${styles.header} ${scrolled ? styles.scrolled : ""}`} id="site-header">
      <div className={styles.inner}>
        ...
        <div className={styles.rightCluster}>
          ...
          >
            <img src="/images/app-store-badge.svg" alt="Download on the App Store" width={90} height={30} loading="lazy" decoding="async" />
          </a>
          <a
            className={styles.appBadge}
          ...
          >
            <img src="/images/google-play-badge.png" alt="Get it on Google Play" width={90} height={27} loading="lazy" decoding="async" />
          </a>
          <button
            type="button"
